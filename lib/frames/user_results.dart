...
class _UserResultsState extends State<UserResults> {
   ValueRangeModel? valores = ValueRangeModel(idValueRange: 1, idTest: 1, minimumAge: 1, maximumAge: 1, minimumWeight:1, maximunWeight: 1, minimumHeight: 1, maximumHeight: 1);
